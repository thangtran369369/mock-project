...
<meta charset="UTF-8">
    ...
    <!-- ::::::::::::::Favicon icon::::::::::::::-->
    <link rel="shortcut icon" href="<c:url value='template/web/assets/img/favicon.png'/>" type="image/png">

    <!-- ::::::::::::::All CSS Files here :::::::::::::: -->

    <!-- Vendor CSS Files -->
    <link rel="stylesheet" href="<c:url value='template/web/assets/css/vendor/jquery-ui.min.css'/>">
    <link rel="stylesheet" href="<c:url value='template/web/assets/css/vendor/fontawesome.css'/>">
    <link rel="stylesheet" href="<c:url value='template/web/assets/css/vendor/plaza-icon.css'/>">
    <link rel="stylesheet" href="<c:url value='template/web/assets/css/vendor/bootstrap.min.css'/>">

    <!-- Plugin CSS Files -->
    <link rel="stylesheet" href="<c:url value='template/web/assets/css/plugin/swiper.min.css'/>">
    <link rel="stylesheet" href="<c:url value='template/web/assets/css/plugin/material-scrolltop.css'/>">
    <link rel="stylesheet" href="<c:url value='template/web/assets/css/plugin/price_range_style.css'/>">
    <link rel="stylesheet" href="<c:url value='template/web/assets/css/plugin/in-number.css'/>">
    <link rel="stylesheet" href="<c:url value='template/web/assets/css/plugin/venobox.min.css'/>">
...
<body>
	<header>
							...
							<div class="header__top-content">
								<div class="header__top-content--left">
									<div class="contact_cms">
										<span class="cms1">Telephone Enquiry: </span> <span
											class="cms2">(012) 800 456 789 - 987</span>
									</div>
								</div>
								<div class="header__top-content--right">
									...
									<div class="user-currency user-set-role">
										<a class="user-set-role__button" href="#"
											data-toggle="dropdown" aria-haspopup="true">USD $<i
											class="fal fa-chevron-down"></i></a>
										<ul class="expand-dropdown-menu dropdown-menu">
											<li><a href="#">USD $</a></li>
											<li><a href="#">EURO €</a></li>
									...
									<div class="user-info user-set-role">
										<a class="user-set-role__button" href="#"
											data-toggle="dropdown" aria-haspopup="true"> <img
											src="<c:url value='template/web/assets/img/icon/flag/icon_usa.png'/>"
											alt="">USA <i class="fal fa-chevron-down"></i></a>
										<ul class="expand-dropdown-menu dropdown-menu">
											<li><a href="#"><img
													src="<c:url value='template/web/assets/img/icon/flag/icon_usa.png'/>"
													alt="">English</a></li>
											<li><a href="#"><img
													src="<c:url value='template/web/assets/img/icon/flag/icon_france.png'/> "
													alt=""> Francais</a></li>
										</ul>
									</div>
								</div>
						...
						<div class="col-lg-3">
							<div class="header__logo">
								<a href="index.html" class="header__logo-link"> <img
									src="<c:url value='template/web/assets/img/logo/logo-color.jpg'/>"
									...
									<form class="header__search-form" action="#">
										<div class="header__search-category">
											<select class="bootstrap-select" name="poscats">
												...
												<option value="39">- - - - T-shirts &amp; Tank Tops
												</option>
												...
												<option value="68">- - - - Baby &amp; Toddler Toys
												</option>
												<option value="69">- - - - Electronics for Kids</option>
												<option value="70">- - - - Dolls &amp; Accessories
												</option>
								...
								<div class="col-lg-2">
									<div class="header__wishlist-box">
										...
										<div class="header__wishlist pos-relative">
											<a href="wishlist.html" class="header__wishlist-link"> <i
						...
						<nav>
							<ul class="header__nav">
								...
								<li class="header__nav-item pos-relative"><a href="#"
									class="header__nav-link">Home <i class="icon-chevron-down"></i></a>
									<!--Single Dropdown Menu-->
									<ul class="dropdown__menu pos-absolute">
										<li class="dropdown__list"><a href="index.html"
											class="dropdown__link">Home 1</a></li>
										<li class="dropdown__list"><a href="index-2.html"
											class="dropdown__link">Home 2</a></li>
										<li class="dropdown__list"><a href="index-3.html"
											class="dropdown__link">Home 3</a></li>
										<li class="dropdown__list"><a href="index-4.html"
											class="dropdown__link">Home 4</a></li>
									</ul> <!--Single Dropdown Menu--></li>
								<!-- End Single Nav link-->

								<!--Start Single Nav link-->
								<li class="header__nav-item pos-relative"><a href="#"
									class="header__nav-link">Pages <i class="icon-chevron-down"></i></a>
									<!--Single Dropdown Menu-->
									<ul class="dropdown__menu pos-absolute">
										<li class="dropdown__list"><a href="about.html"
											class="dropdown__link">About</a></li>
										<li class="dropdown__list"><a href="cart.html"
											class="dropdown__link">Cart</a></li>
										<li class="dropdown__list"><a href="checkout.html"
											class="dropdown__link">Checkout</a></li>
										<li class="dropdown__list"><a href="compare.html"
											class="dropdown__link">Compare</a></li>
										<li class="dropdown__list"><a href="empty-cart.html"
											class="dropdown__link">Empty Cart</a></li>
										<li class="dropdown__list"><a href="wishlist.html"
											class="dropdown__link">Wishlist</a></li>
										<li class="dropdown__list"><a href="my-account.html"
											class="dropdown__link">My Account</a></li>
										<li class="dropdown__list"><a href="login.html"
											class="dropdown__link">Login</a></li>
										<li class="dropdown__list"><a href="404-page.html"
											class="dropdown__link">404 Page</a></li>
									</ul> <!--Single Dropdown Menu--></li>
								<!-- End Single Nav link-->
								...
								<li class="header__nav-item pos-relative"><a href="#"
									...
									<ul class="mega-menu pos-absolute">
										<li class="mega-menu__box">
											...
											<div class="mega-menu__item-box">
												...
												<ul class="mega-menu__item">
													<li class="mega-menu__list"><a href="shop-1.html"
														class="mega-menu__link">Shop Default</a></li>
													<li class="mega-menu__list"><a href="shop-4-grid.html"
										...
										<li class="mega-menu__banner"><a href="shop-1.html"
								...
								<!--Start Single Nav link-->
								<li class="header__nav-item pos-relative"><a href="#"
									class="header__nav-link">Custom Block <i
										class="icon-chevron-down"></i></a> <!-- Megamenu Menu-->
									<ul class="mega-menu pos-absolute">
										<li class="mega-menu__box">
											<!--Single Megamenu Item Menu-->
											<div class="mega-menu__item-box">
												<span class="mega-menu__title">Women Is Clothes &
													Fashion</span>
												<ul class="mega-menu__item">
													<li><p>Shop Women Is Clothing And Accessories And
															Get Inspired By The Latest Fashion Trends.</p></li>
												</ul>
											</div> <!--Single Megamenu Item Menu--> <!--Single Megamenu Item Menu-->
											<div class="mega-menu__item-box">
												<span class="mega-menu__title">Simple Style</span>
												<ul class="mega-menu__item">
													<li><p>A New Flattering Style With All The Comfort
															Of Our Linen.</p></li>
												</ul>
											</div> <!--Single Megamenu Item Menu--> <!--Single Megamenu Item Menu-->
											<div class="mega-menu__item-box">
												...
												<ul class="mega-menu__item">
													<li><p>Endless Styling Possibilities In A
															Collection Full Of Versatile Pieces.</p></li>
												</ul>
											</div> <!--Single Megamenu Item Menu-->
		...
		<div id="offcanvas-add-cart__box"
			class="offcanvas offcanvas-cart offcanvas-add-cart">
			<div class="offcanvas-add-cart__top m-b-40">
				<span class="offcanvas-add-cart__top-text"><i
					class="icon-shopping-cart"></i> Total Items: 4</span>
			...
			<ul class="offcanvas-add-cart__menu">
				...
				<li class="offcanvas-add-cart__list pos-relative">
					<div class="offcanvas-add-cart__img-box pos-relative">
						<a href="single-1.html"
							...
							src="assets/img/product/size-small/product-home-1-img-1.jpg"
							alt="" class="add-cart__img"></a> <span
							class="offcanvas-add-cart__item-count pos-absolute">2x</span>
					</div>
					<div class="offcanvas-add-cart__detail">
						<a href="single-1.html" class="offcanvas-add-cart__link">PlayStation
							4 Pro 1TB Star Wars Battlefront II Bundle</a> <span
							class="offcanvas-add-cart__price">$29.00</span> <span
							class="offcanvas-add-cart__info">Dimension: 40x60cm</span>
				...
				<li class="offcanvas-add-cart__list pos-relative">
					<div class="offcanvas-add-cart__img-box pos-relative">
						<a href="single-1.html"
							class="offcanvas-add-cart__img-link img-responsive"><img
							src="assets/img/product/size-small/product-home-1-img-2.jpg"
							alt="" class="add-cart__img"></a> <span
							class="offcanvas-add-cart__item-count pos-absolute">1x</span>
					</div>
					<div class="offcanvas-add-cart__detail">
						<a href="single-1.html" class="offcanvas-add-cart__link">PlayStation
							4 Pro 1TB Star Wars Battlefront II Bundle</a> <span
			...
			<div class="offcanvas-add-cart__checkout-box-bottom">
				...
				<ul class="offcanvas-add-cart__checkout-info">
					...
					<li class="offcanvas-add-cart__checkout-list"><span
						class="offcanvas-add-cart__checkout-left-info">Subtotal</span> <span
						class="offcanvas-add-cart__checkout-right-info">$60.59</span></li>
					<!-- End Single Add Cart Checkout Info-->
					<!-- Start Single Add Cart Checkout Info-->
					<li class="offcanvas-add-cart__checkout-list"><span
						class="offcanvas-add-cart__checkout-left-info">Shipping</span> <span
						class="offcanvas-add-cart__checkout-right-info">$7.00</span></li>
					<!-- End Single Add Cart Checkout Info-->
					<!-- Start Single Add Cart Checkout Info-->
					<li class="offcanvas-add-cart__checkout-list"><span
						class="offcanvas-add-cart__checkout-left-info">Taxes</span> <span
						class="offcanvas-add-cart__checkout-right-info">$0.00</span></li>
					<!-- End Single Add Cart Checkout Info-->
					<!-- Start Single Add Cart Checkout Info-->
					<li class="offcanvas-add-cart__checkout-list"><span
						class="offcanvas-add-cart__checkout-left-info">Total</span> <span
						class="offcanvas-add-cart__checkout-right-info">$67.59</span></li>
					<!-- End Single Add Cart Checkout Info-->
				</ul>
