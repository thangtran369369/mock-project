                            ...
                            <div class="col-md-6">
                                <div class="product-gallery-box m-b-60">
                                    <div class="product-image--large overflow-hidden">
                                        <img class="img-fluid" id="img-zoom" src="<c:url value='template/web/assets/img/product/gallery/gallery-large/product-gallery-large-1.jpg' />" data-zoom-image="<c:url value='template/web/assets/img/product/gallery/gallery-large/product-gallery-large-1.jpg'/>" alt="">
                                        ...
                                        <div id="gallery-zoom" class="product-image--thumb product-image--thumb-horizontal overflow-hidden swiper-outside-arrow-hover m-lr-30">
                                            <div class="swiper-wrapper">
                                                <div class="swiper-slide">
                                                    <a class="zoom-active" data-image="<c:url value='template/web/assets/img/product/gallery/gallery-large/product-gallery-large-1.jpg' />" data-zoom-image="<c:url value='template/web/assets/img/product/gallery/gallery-large/product-gallery-large-1.jpg'/>">
                                                        <img class="img-fluid" src="<c:url value='template/web/assets/img/product/gallery/gallery-thumb/product-gallery-thumb-1.jpg'/>" alt="">
                                                    </a>
                                                </div>
                                                <div class="swiper-slide">
                                                    <a data-image="<c:url value='template/web/assets/img/product/gallery/gallery-large/product-gallery-large-2.jpg'/>" data-zoom-image="<c:url value='template/web/assets/img/product/gallery/gallery-large/product-gallery-large-2.jpg'/>">
                                                        <img class="img-fluid" src="template/web/assets/img/product/gallery/gallery-thumb/product-gallery-thumb-2.jpg" alt="">
                                                    </a>
                                                </div>
                                                <div class="swiper-slide">
                                                    <a data-image="<c:url value='template/web/assets/img/product/gallery/gallery-large/product-gallery-large-3.jpg'/>" data-zoom-image="<c:url value='template/web/assets/img/product/gallery/gallery-large/product-gallery-large-3.jpg'/>">
                                                        <img class="img-fluid" src="<c:url value='template/web/assets/img/product/gallery/gallery-thumb/product-gallery-thumb-3.jpg'/>" alt="">
                                                    </a>
                                                </div>
                                                 <div class="swiper-slide">
                                                    <a data-image="<c:url value='template/web/assets/img/product/gallery/gallery-large/product-gallery-large-4.jpg'/>" data-zoom-image="<c:url value='template/web/assets/img/product/gallery/gallery-large/product-gallery-large-4.jpg'/>">
                                                        <img class="img-fluid" src="<c:url value='template/web/assets/img/product/gallery/gallery-thumb/product-gallery-thumb-4.jpg'/>" alt="">
                                                    </a>
                                                </div>
                                                 <div class="swiper-slide">
                                                    <a data-image="<c:url value='template/web/assets/img/product/gallery/gallery-large/product-gallery-large-5.jpg'/>" data-zoom-image="<c:url value='template/web/assets/img/product/gallery/gallery-large/product-gallery-large-5.jpg'/>">
                                                        <img class="img-fluid" src="<c:url value='template/web/assets/img/product/gallery/gallery-thumb/product-gallery-thumb-5.jpg'/>" alt="">
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane" id="product-dis">
                                        <div class="product-dis__content">
                                            <a href="#" class="product-dis__img m-b-30"><img src="<c:url value='template/web/assets/img/logo/another-logo.jpg'/>" alt=""></a>
                                    ...
                                    <div class="tab-pane " id="product-review">
                                        ...
                                        <ul class="comment">
                                            ...
                                            <li class="comment__list">
                                                <div class="comment__wrapper">
                                                    <div class="comment__img">
                                                        <img src="<c:url value='template/web/assets/img/user/image-1.png'/>" alt=""> 
                                                    </div>
                                                ...
                                                <ul class="comment__reply">
                                                    <li class="comment__reply-list">
                                                        <div class="comment__wrapper">
                                                            <div class="comment__img">
                                                                <img src="<c:url value='template/web/assets/img/user/image-2.png'/>" alt=""> 
                                                            </div>
                                                            <div class="comment__content">
                                                                <div class="comment__content-top">
                                                                    <div class="comment__content-left">
                                            ...
                                            <li class="comment__list">
                                                <div class="comment__wrapper">
                                                    <div class="comment__img">
                                                        <img src="<c:url value='template/web/assets/img/user/image-3.png'/>" alt=""> 
                                                    </div>
                                                    <div class="comment__content">
                                                        <div class="comment__content-top">
                                                            <div class="comment__content-left">
                                    ...
                                    <div class="product-default-slider-5grid overflow-hidden  m-t-50">
                                        <div class="swiper-wrapper">
                                            ...
                                            <div class="product__box product__box--default product__box--border-hover swiper-slide text-center">
                                                <div class="product__img-box">
                                                    <a href="single-1.html" class="product__img--link">
                                                        <img class="product__img" src="<c:url value='template/web/assets/img/product/size-normal/product-home-1-img-1.jpg'/>" alt="">
                                                    </a>
                                            ...
                                            <div class="product__box product__box--default product__box--border-hover swiper-slide text-center">
                                                <div class="product__img-box">
                                                    <a href="single-1.html" class="product__img--link">
                                                        <img class="product__img" src="<c:url value='template/web/assets/img/product/size-normal/product-home-1-img-2.jpg'/>" alt="">
                                                    </a>
                                            ...
                                            <div class="product__box product__box--default product__box--border-hover swiper-slide text-center">
                                                <div class="product__img-box">
                                                    <a href="single-1.html" class="product__img--link">
                                                        <img class="product__img" src="<c:url value='template/web/assets/img/product/size-normal/product-home-1-img-3.jpg'/>" alt="">
                                                    </a>
                                            ...
                                            <div class="product__box product__box--default product__box--border-hover swiper-slide text-center">
                                                <div class="product__img-box">
                                                    <a href="single-1.html" class="product__img--link">
                                                        <img class="product__img" src="<c:url value='template/web/assets/img/product/size-normal/product-home-1-img-4.jpg'/>" alt="">
                                                    </a>
                                            ...
                                            <div class="product__box product__box--default product__box--border-hover swiper-slide text-center">
                                                <div class="product__img-box">
                                                    <a href="single-1.html" class="product__img--link">
                                                        <img class="product__img" src="<c:url value='template/web/assets/img/product/size-normal/product-home-1-img-5.jpg'/>" alt="">
                                                    </a>
                                            ...
                                            <div class="product__box product__box--default product__box--border-hover swiper-slide text-center">
                                                <div class="product__img-box">
                                                    <a href="single-1.html" class="product__img--link">
                                                        <img class="product__img" src="<c:url value='template/web/assets/img/product/size-normal/product-home-1-img-6.jpg'/>" alt="">
                                                    </a>
                                            ...
                                            <div class="product__box product__box--default product__box--border-hover swiper-slide text-center">
                                                <div class="product__img-box">
                                                    <a href="single-1.html" class="product__img--link">
                                                        <img class="product__img" src="<c:url value='template/web/assets/img/product/size-normal/product-home-1-img-7.jpg'/>" alt="">
                                                    </a>
                                            ...
                                            <div class="product__box product__box--default product__box--border-hover swiper-slide text-center">
                                                <div class="product__img-box">
                                                    <a href="single-1.html" class="product__img--link">
                                                        <img class="product__img" src="<c:url value='template/web/assets/img/product/size-normal/product-home-1-img-8.jpg'/>" alt="">
                                                    </a>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="modal__product-img">
                                        <img class="img-fluid" src="<c:url value='template/web/assets/img/product/size-normal/product-home-1-img-1.jpg'/>" alt="">
                                    </div>
                                </div>
                                <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="product-gallery-box m-b-60">
                                    <div class="modal-product-image--large overflow-hidden">
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide"><img class="img-fluid" src="<c:url value='template/web/assets/img/product/gallery/gallery-large/product-gallery-large-1.jpg'/>" alt=""></div>
                                            <div class="swiper-slide"><img class="img-fluid" src="<c:url value='template/web/assets/img/product/gallery/gallery-large/product-gallery-large-2.jpg'/>" alt=""></div>
                                            <div class="swiper-slide"><img class="img-fluid" src="<c:url value='template/web/assets/img/product/gallery/gallery-large/product-gallery-large-3.jpg'/>" alt=""></div>
                                            <div class="swiper-slide"><img class="img-fluid" src="<c:url value='template/web/assets/img/product/gallery/gallery-large/product-gallery-large-4.jpg'/>" alt=""></div>
                                            <div class="swiper-slide"><img class="img-fluid" src="<c:url value='template/web/assets/img/product/gallery/gallery-large/product-gallery-large-5.jpg'/>" alt=""></div>
                                        </div>
                                    </div>
                                    <div class="pos-relative">
                                        <div class="modal-product-image--thumb overflow-hidden swiper-outside-arrow-hover m-lr-30">
                                            <div class="swiper-wrapper ">
                                                <div class="swiper-slide"><img class="img-fluid" src="<c:url value='template/web/assets/img/product/gallery/gallery-thumb/product-gallery-thumb-1.jpg'/>" alt=""></div>
                                                <div class="swiper-slide"><img class="img-fluid" src="<c:url value='template/web/assets/img/product/gallery/gallery-thumb/product-gallery-thumb-2.jpg'/>" alt=""></div>
                                                <div class="swiper-slide"><img class="img-fluid" src="<c:url value='template/web/assets/img/product/gallery/gallery-thumb/product-gallery-thumb-3.jpg'/>" alt=""></div>
                                                <div class="swiper-slide"><img class="img-fluid" src="<c:url value='template/web/assets/img/product/gallery/gallery-thumb/product-gallery-thumb-4.jpg'/>" alt=""></div>
                                                <div class="swiper-slide"><img class="img-fluid" src="<c:url value='template/web/assets/img/product/gallery/gallery-thumb/product-gallery-thumb-5.jpg'/>" alt=""></div>
                                            </div>
                                        </div>
                                        <div class="swiper-buttons">
                                            <!-- Add Arrows -->
                        ...
                        <div class="row">
                           <div class="col-md-6">
                                <div class="modal-review-img">
                                    <img class="img-fluid  border-around" src="<c:url value='template/web/assets/img/product/size-large/product-home-1-lg-img-1.jpg'/>" alt="">
                                </div>
